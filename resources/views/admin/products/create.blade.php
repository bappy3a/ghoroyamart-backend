...
@section('content')
<form id="createproduct-form" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    <div class="row">
        <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control d-none" id="product-id-input" name="product_id">
                            <input type="text" class="form-control" id="product-title-input" name="name" value="{{ old('name') }}" placeholder="Enter product title" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="sku-input" name="sku" value="{{ old('sku') }}" placeholder="Enter product SKU">
                            @error('sku')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        {{-- <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="landing-page-slug-input" name="landing_page_slug" value="{{ old('landing_page_slug') }}" placeholder="e.g. beauty-serum-offer">
                            <small class="text-muted">Landing URL: {{ url('/landing') }}/your-slug</small>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <textarea class="form-control" id="how-to-use-input" name="how_to_use" rows="6" placeholder="Enter how to use instructions">{{ old('how_to_use') }}</textarea>
                                    @error('how_to_use')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <textarea class="form-control" id="good-to-know-input" name="good_to_know" rows="6" placeholder="Enter good to know information">{{ old('good_to_know') }}</textarea>
                                    @error('good_to_know')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" class="form-control" id="video-media-input" name="video_media" value="{{ old('video_media') }}" placeholder="Enter YouTube, Vimeo, or other video URL">
                                    </div>
                                    @error('video_media')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-lg-4">
                                <div class="mb-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="warranty-input" name="warranty" value="{{ old('warranty') }}" placeholder="e.g. 1 Year">
                                    </div>
                                    @error('warranty')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="stocks-input" name="quantity" value="{{ old('quantity') }}" placeholder="Quantity" min="0" required>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="product-price-input" name="regular_price" value="{{ old('regular_price') }}" placeholder="Enter price" aria-label="Price" aria-describedby="product-price-addon" min="0" required>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="purchase-price-input" name="purchase_price" value="{{ old('purchase_price') }}" placeholder="Enter purchase price">
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="product-location-input" name="product_location">
                                                <option value="store" {{ old('product_location', 'store') == 'store' ? 'selected' : '' }}>Store</option>
                                                <option value="warehouse" {{ old('product_location') == 'warehouse' ? 'selected' : '' }}>Warehouse</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="low-stock-input" name="low_stock_alert" value="{{ old('low_stock_alert', 0) }}" placeholder="Alert at" min="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="discount-start-date" name="discount_start_date" value="{{ old('discount_start_date') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="discount-end-date" name="discount_end_date" value="{{ old('discount_end_date') }}">
                            ...
                            <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter meta title" id="meta-title-input" name="meta_title" value="{{ old('meta_title') }}">
                                            @error('meta_title')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter meta keywords" id="meta-keywords-input" name="meta_keywords" value="{{ old('meta_keywords') }}">
                                            @error('meta_keywords')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control" id="meta-description-input" name="meta_description" placeholder="Enter meta description" rows="3">{{ old('meta_description') }}</textarea>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <input type="date" id="datepicker-publish-input" name="published_at" class="form-control"
                            value="{{ old('published_at') }}" placeholder="Enter publish date" data-provider="flatpickr" data-date-format="d.m.y"
                            data-enable-time>
                        @error('published_at')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="md-3">
                        <label for="choices-publish-status-input" class="form-label">Product Category</label>
                    ...
                    <div class="mt-3">
                        <label for="choices-publish-status-input" class="form-label">Product Brand</label>
                    ...
                    <div class="mt-3">
                        <label for="choices-publish-status-input" class="form-label">Product Unit</label>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <textarea class="form-control" name="short_description" placeholder="Must enter minimum of a 100 characters" rows="3">{{ old('short_description') }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is-new" name="is_new" value="1" {{ old('is_new') ? 'checked' : '' }}>
                    ...
                    <div class="mb-0">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is-best-seller" name="is_best_seller" value="1" {{ old('is_best_seller') ? 'checked' : '' }}>
