...
@section('title', 'Create Promotion Landing Page')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Create Promotion Landing Page</h4>
...
<form action="{{ route('promotion-landing-pages.store') }}" method="POST" enctype="multipart/form-data">
