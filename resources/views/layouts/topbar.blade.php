        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('logo.svg') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('logo.svg') }}" alt="" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a href="{{ route('home') }}" target="_blank" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" >
                        <i class='bx bx-arrow fs-22'></i>
                    </a>
                </div>
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        @if(isset($pendingOrdersCount) && $pendingOrdersCount > 0)
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{ $pendingOrdersCount }}<span class="visually-hidden">pending orders</span></span>
                        @endif
                    </button>
                        ...
                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                            <div class="p-3">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="m-0 fs-16 fw-semibold text-white"> Pending Orders </h6>
                                    </div>
                                    <div class="col-auto dropdown-tabs">
                                        @if(isset($pendingOrdersCount) && $pendingOrdersCount > 0)
                                            <span class="badge bg-light-subtle text-body fs-13">{{ $pendingOrdersCount }} New</span>
                                        @else
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        @foreach($pendingOrders as $index => $order)
                                            <div class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <a href="{{ auth()->user()?->can('orders.details') ? route('orders.view', ['order' => $order->order_number, 'return_url' => route('orders.pending')]) : route('orders.pending') }}" class="stretched-link">
                                                            <h6 class="mt-0 mb-2 lh-base">
                                                                New Order: <b>{{ $order->order_number }}</b>
                                                            </h6>
                                                        ...
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                            <span><i class="mdi mdi-clock-outline"></i> {{ $order->created_at->diffForHumans() }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @else
                                        <div class="text-center py-4">
                                            <div class="avatar-md mx-auto mb-3">
                                                <span class="avatar-title bg-light-subtle text-muted rounded-circle fs-24">
                                    ...
                                    @if(isset($pendingOrdersCount) && $pendingOrdersCount > 0)
                                        <div class="my-3 text-center view-all">
                                            <a href="{{ route('orders.pending') }}" class="btn btn-soft-success waves-effect waves-light">
                                                View All Orders <i class="ri-arrow-right-line align-middle"></i>
                                            </a>
                                        </div>
                                    @endif
                                </div>
